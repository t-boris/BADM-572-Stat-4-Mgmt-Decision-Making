...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  {
    id: "m3-response-variable",
    term: { ru: "Зависимая переменная", en: "Response / dependent variable" },
    definition: { ru: "Результат, который исследователь хочет объяснить, предсказать или улучшить; обычно обозначается Y.", en: "The outcome a researcher wants to explain, predict or improve, usually denoted Y." },
    moduleId: 3,
    related: ["m3-independent-variable"],
    tags: ["design", "variables"],
  },
  {
    id: "m3-independent-variable",
    term: { ru: "Независимая переменная", en: "Independent / explanatory variable" },
    definition: { ru: "Фактор, связанный с response variable; в эксперименте исследователь назначает или меняет его уровни.", en: "A factor related to the response; in an experiment the researcher assigns or manipulates its levels." },
    moduleId: 3,
    related: ["m3-response-variable", "m3-level"],
    tags: ["design", "variables"],
  },
  {
    id: "m3-level",
    term: { ru: "Уровень независимой переменной", en: "Level of an independent variable" },
    definition: { ru: "Одно из экспериментальных условий: treatment/control — два уровня; пять диет — пять уровней.", en: "One experimental condition: treatment/control gives two levels; five diets give five levels." },
    moduleId: 3,
    related: ["m3-independent-variable"],
    tags: ["design"],
  },
  {
    id: "m3-experimental-study",
    term: { ru: "Экспериментальное исследование", en: "Experimental study" },
    definition: { ru: "Исследователь назначает или меняет independent variable и измеряет ответ, создавая основу для причинного вывода.", en: "The researcher assigns or manipulates an independent variable and measures the response, creating a basis for causal inference." },
    moduleId: 3,
    related: ["m3-observational-study", "m3-random-assignment"],
    tags: ["design"],
  },
  {
    id: "m3-observational-study",
    term: { ru: "Наблюдательное исследование", en: "Observational study" },
    definition: { ru: "Исследователь измеряет существующие различия, не назначая уровни explanatory variable; результат прежде всего показывает association.", en: "The researcher measures existing differences without assigning levels of the explanatory variable; the result primarily shows association." },
    moduleId: 3,
    related: ["m3-experimental-study"],
    tags: ["design"],
  },
  {
    id: "m3-cross-sectional",
    term: { ru: "Поперечные данные", en: "Cross-sectional data" },
    definition: { ru: "Данные по многим единицам, собранные в один момент или примерно один период.", en: "Data on many units collected at the same or approximately the same point in time." },
    moduleId: 3,
    related: ["m3-time-series"],
    tags: ["data"],
  },
  {
    id: "m3-time-series",
    term: { ru: "Временной ряд", en: "Time-series data" },
    definition: { ru: "Последовательные наблюдения одной величины во многих временных периодах.", en: "Sequential observations of one quantity over many time periods." },
    moduleId: 3,
    related: ["m3-cross-sectional"],
    tags: ["data"],
  },
  {
    id: "m3-sampling-frame",
    term: { ru: "Основа выборки", en: "Sampling frame" },
    definition: { ru: "Фактический список или механизм доступа, из которого выбираются единицы; вывод безопасно обобщается прежде всего на его охват.", en: "The actual list or access mechanism from which units are sampled; inference safely generalizes first to what it covers." },
    moduleId: 3,
    related: ["m3-srs", "m3-coverage-bias"],
    tags: ["sampling"],
  },
  {
    id: "m3-coverage-bias",
    term: { ru: "Смещение охвата", en: "Coverage bias" },
    definition: { ru: "Sampling frame систематически не включает часть population или включает некоторые группы непропорционально часто.", en: "The sampling frame systematically excludes part of the population or includes some groups disproportionately often." },
    moduleId: 3,
    related: ["m3-sampling-frame", "m3-bias"],
    tags: ["sampling", "risk"],
  },
  {
    id: "m3-bias",
    term: { ru: "Смещение", en: "Bias" },
    definition: { ru: "Систематическая склонность процедуры отбора или измерения искажать результат в определённую сторону; рост n сам по себе её не устраняет.", en: "A systematic tendency of a selection or measurement procedure to distort a result in a particular direction; increasing n alone does not remove it." },
    moduleId: 3,
    related: ["m3-nonresponse", "m3-volunteer"],
    tags: ["sampling", "risk"],
  },
  {
    id: "m3-volunteer",
    term: { ru: "Добровольная выборка", en: "Volunteer sample" },
    definition: { ru: "Участники сами включают себя; люди с сильным мнением обычно представлены непропорционально часто.", en: "Participants include themselves; people with strong opinions are typically over-represented." },
    moduleId: 3,
    related: ["m3-bias", "m3-convenience"],
    tags: ["sampling", "non-probability"],
  },
  {
    id: "m3-convenience",
    term: { ru: "Удобная выборка", en: "Convenience sample" },
    definition: { ru: "Единицы выбираются из-за лёгкой доступности, а не по вероятностному плану.", en: "Units are chosen for easy accessibility rather than through a probability plan." },
    moduleId: 3,
    related: ["m3-volunteer", "m3-bias"],
    tags: ["sampling", "non-probability"],
  },
  {
    id: "m3-nonresponse",
    term: { ru: "Смещение неответа", en: "Nonresponse bias" },
    definition: { ru: "Отвечающие систематически отличаются от выбранных, но не ответивших людей по интересующей переменной.", en: "Respondents differ systematically from selected nonrespondents on the variable of interest." },
    moduleId: 3,
    related: ["m3-bias", "m3-srs"],
    tags: ["sampling", "risk"],
  },
  {
    id: "m3-srs",
    term: { ru: "Простая случайная выборка", en: "Simple random sample" },
    definition: { ru: "Каждая возможная выборка заданного размера имеет одинаковую вероятность быть выбранной.", en: "Every possible sample of the specified size has the same probability of selection." },
    moduleId: 3,
    related: ["m3-stratified", "m3-cluster"],
    tags: ["sampling", "probability"],
  },
  {
    id: "m3-stratified",
    term: { ru: "Стратифицированная выборка", en: "Stratified sampling" },
    definition: { ru: "Population делят на strata и берут случайные наблюдения из каждой, гарантируя представительство всех важных подгрупп.", en: "The population is divided into strata and sampled randomly within every one, guaranteeing representation of all important subgroups." },
    moduleId: 3,
    related: ["m3-srs", "m3-cluster"],
    tags: ["sampling", "probability"],
  },
  {
    id: "m3-cluster",
    term: { ru: "Кластерная выборка", en: "Cluster sampling" },
    definition: { ru: "Выбираются некоторые естественные группы, после чего обследуются все или часть единиц внутри выбранных групп.", en: "Some natural groups are selected, then all or some units inside the selected groups are studied." },
    moduleId: 3,
    related: ["m3-srs", "m3-stratified"],
    tags: ["sampling", "probability"],
  },
  {
    id: "m3-random-assignment",
    term: { ru: "Случайное распределение", en: "Random assignment" },
    definition: { ru: "Случайное назначение участников в treatment groups; защищает внутреннюю валидность причинного сравнения.", en: "Randomly assigning participants to treatment groups; protects the internal validity of a causal comparison." },
    moduleId: 3,
    related: ["m3-experimental-study"],
    tags: ["design", "experiment"],
  },
  {
    id: "m3-sampling-distribution",
    term: { ru: "Выборочное распределение", en: "Sampling distribution" },
    definition: { ru: "Теоретическое распределение statistic по всем возможным случайным samples фиксированного размера.", en: "The theoretical distribution of a statistic over all possible random samples of a fixed size." },
    moduleId: 3,
    related: ["m3-standard-error", "m3-clt"],
    tags: ["sampling-distribution"],
  },
  {
    id: "m3-standard-error",
    term: { ru: "Стандартная ошибка", en: "Standard error" },
    definition: { ru: "Стандартное отклонение sampling distribution статистики; для среднего равно σ/√n.", en: "The standard deviation of a statistic's sampling distribution; for a mean it equals σ/√n." },
    moduleId: 3,
    formula: "SE(x̄) = σ/√n",
    related: ["m3-sampling-distribution", "m3-clt"],
    tags: ["formula", "sampling-distribution"],
  },
  {
    id: "m3-clt",
    term: { ru: "Центральная предельная теорема", en: "Central Limit Theorem" },
    definition: { ru: "При конечных μ и σ² sampling distribution среднего приближается к normal со средним μ и variance σ²/n по мере роста n.", en: "With finite μ and σ², the sampling distribution of the mean approaches normal with mean μ and variance σ²/n as n grows." },
    moduleId: 3,
    formula: "x̄ ≈ N(μ, σ/√n)",
    related: ["m3-standard-error", "m3-sampling-distribution"],
    tags: ["theorem", "sampling-distribution"],
  },
  {
    id: "m3-point-estimator",
    term: { ru: "Точечная оценка", en: "Point estimator" },
    definition: { ru: "Statistic, используемая как одночисловая оценка population parameter: x̄ оценивает μ, p̂ оценивает p.", en: "A statistic used as a one-number estimate of a population parameter: x̄ estimates μ and p̂ estimates p." },
    moduleId: 3,
    related: ["m3-sample-proportion", "m3-standard-error"],
    tags: ["inference"],
  },
  {
    id: "m3-sample-proportion",
    term: { ru: "Выборочная доля", en: "Sample proportion" },
    definition: { ru: "Доля интересующей категории в sample; p̂ = x/n и служит point estimate для population proportion p.", en: "The category's share in a sample; p̂ = x/n and it serves as a point estimate of population proportion p." },
    moduleId: 3,
    formula: "p̂ = x/n",
    related: ["m3-proportion-se", "m3-point-estimator"],
    tags: ["proportion", "formula"],
  },
  {
    id: "m3-proportion-se",
    term: { ru: "Стандартная ошибка доли", en: "Standard error of a proportion" },
    definition: { ru: "Разброс sample proportions вокруг p; normal approximation проверяется через np ≥ 10 и n(1−p) ≥ 10.", en: "The spread of sample proportions around p; check the normal approximation with np ≥ 10 and n(1−p) ≥ 10." },
    moduleId: 3,
