...
| Раздел | Что даёт |
|--------|----------|
| **Модули** | Полный текст модуля: определения (RU + EN), формулы, кейсы, ловушки, чек-листы |
| **Интерактивы** | Классификатор переменных, шкалы измерения, выборка vs совокупность, конструктор частотных таблиц, исследователь гистограмм, круговая vs столбчатая, диаграмма рассеяния и временной ряд, помощник выбора графика |
| **Excel** | 6 пошаговых практикумов из видео-иллюстраций курса (FREQUENCY, COUNTIF, Analysis ToolPak, pie of pie, scatter) |
| **Песочница** | Загрузить свои числа или датасет из лекции → частотная таблица, гистограмма, bar, pie, экспорт в CSV |
| **Глоссарий** | 44 термина с определениями на двух языках и формулами |
| **Тесты** | 20 вопросов на модуль (4 easy · 12 medium · 4 hard), режим на время, разбор ответов |
